...
function startEvidencePan(event, elements = getEvidenceModalElements(), initialScrollLeft = elements.imageWrap?.scrollLeft || 0, initialScrollTop = elements.imageWrap?.scrollTop || 0) {
    if (!elements.imageWrap) {
        return;
    }
